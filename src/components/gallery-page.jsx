...
// The gallery page will hold a contact form, a maps plugin, biz info, etc.  
      ...
      <React.Fragment>
        ...
        <Row>
          <Col>
			...
			<Row>
				<div class="col-4 col-sm-4 col-md-4 col-lg-4"><a href="images/Chicken%20Images/hyline_chicken_image1.jpg">
					<img alt="Hyline Chickens" class="SmallImageMQ" src="images/Chicken%20Thumbnail%20Images/hyline_chicken_image1_thumbnail.jpg"/></a>
				</div>
				<div class="col-4 col-sm-4 col-md-4 col-lg-4"><a href="images/Chicken%20Images/hyline_chicken_image2.jpg">
					<img alt="Hyline Chickens" class="SmallImageMQ" src="images/Chicken%20Thumbnail%20Images/hyline_chicken_image2_thumbnail.jpg"/></a>			
				</div>
				<div class="col-4 col-sm-4 col-md-4 col-lg-4"><a href="images/Chicken%20Images/hyline_chicken_image4.JPG">
					<img alt="Hyline Chickens" class="SmallImageMQ" src="images/Chicken%20Thumbnail%20Images/hyline_chicken_image4_thumbnail.JPG"/></a>
			</div>
       </Row>
